...
public class FancodeBase {
    ...
    protected Map<Integer, String> getCompletedTaskCount(String res) {
        Map<Integer, String> mp = new HashMap<>();
        int count0 = 0, count1 = 0; //count0 is the count of uncompleted task and count1 is the count of completed task
        int userId;
        int oldUserId = 0;
        ...
        //returning a map with key = userId and value = "count0 count1"
        return mp;
    }
